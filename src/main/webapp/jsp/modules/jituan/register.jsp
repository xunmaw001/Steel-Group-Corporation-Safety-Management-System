	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<div class="form-group">
							<label class="label">集团名</label> 
							<input  name="jituanming" placeholder="集团名" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">集团地址</label> 
							<input  name="jituandizhi" placeholder="集团地址" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">法定代表人</label> 
							<input  name="fadingdaibiaoren" placeholder="法定代表人" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">注册资本</label> 
							<input  name="zhuceziben" placeholder="注册资本" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">集团邮箱</label> 
							<input  name="jituanyouxiang" placeholder="集团邮箱" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">官网</label> 
							<input  name="guanwang" placeholder="官网" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">社会统一代码</label> 
							<input  name="shehuitongyidaima" placeholder="社会统一代码" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">集团电话</label> 
							<input  name="jituandianhua" placeholder="集团电话" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">投资人</label> 
							<input  name="touziren" placeholder="投资人" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "jituan/register";
				$.ajax({ 
					type: "POST",
					url: url,
