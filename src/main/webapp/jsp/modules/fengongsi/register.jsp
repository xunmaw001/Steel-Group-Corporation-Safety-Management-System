	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">分公司名</label> 
							<input  name="fengongsiming" placeholder="分公司名" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">分公司账号</label> 
							<input  name="fengongsizhanghao" placeholder="分公司账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">分公司地址</label> 
							<input  name="fengongsidizhi" placeholder="分公司地址" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "fengongsi/register";
				$.ajax({ 
					type: "POST",
					url: url,
