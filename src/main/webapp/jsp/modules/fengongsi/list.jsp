...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>分公司列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">分公司列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										分公司名
									</label>
									<input type="text" id="fengongsimingSearch" class="form-control form-control-sm" placeholder="请输入分公司名" aria-controls="tableId">
									<label>
										分公司账号
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('fengongsidizhi')">分公司地址<i id="fengongsidizhiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#fengongsimingSearch').val() != null && $('#fengongsimingSearch').val() != ''){
				searchForm.fengongsiming ="%" +  $('#fengongsimingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("fengongsi/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				fengongsiming : searchForm.fengongsiming,	
		...
		function setDataRow(item,number){
			...
			var fengongsidizhiCell  = document.createElement('td');

						 fengongsidizhiCell.innerHTML = item.fengongsidizhi;

			row.appendChild(fengongsidizhiCell);
		...
		function sh(){
			...
			httpJson("fengongsi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("fengongsi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"fengongsi");
