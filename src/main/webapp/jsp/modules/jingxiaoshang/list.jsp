...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>经销商列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">经销商列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="jingxiaoshangmingSearch" class="form-control form-control-sm" placeholder="请输入经销商名" aria-controls="tableId">
									<label>
										经销商账号
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jingxiaoshangdizhi')">经销商地址<i id="jingxiaoshangdizhiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#jingxiaoshangmingSearch').val() != null && $('#jingxiaoshangmingSearch').val() != ''){
				searchForm.jingxiaoshangming ="%" +  $('#jingxiaoshangmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("jingxiaoshang/page","GET",{
				...
				jingxiaoshangming : searchForm.jingxiaoshangming,	
		...
		function setDataRow(item,number){
			...
			var jingxiaoshangdizhiCell  = document.createElement('td');

						 jingxiaoshangdizhiCell.innerHTML = item.jingxiaoshangdizhi;

			row.appendChild(jingxiaoshangdizhiCell);
		...
		function sh(){
			...
			httpJson("jingxiaoshang/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jingxiaoshang/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jingxiaoshang");
