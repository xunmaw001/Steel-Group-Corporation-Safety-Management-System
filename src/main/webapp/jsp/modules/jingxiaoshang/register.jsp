	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">经销商名</label> 
							<input  name="jingxiaoshangming" placeholder="经销商名" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">经销商账号</label> 
							<input  name="jingxiaoshangzhanghao" placeholder="经销商账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">经销商地址</label> 
							<input  name="jingxiaoshangdizhi" placeholder="经销商地址" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "jingxiaoshang/register";
				$.ajax({ 
					type: "POST",
					url: url,
